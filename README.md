...
You can run the GeoCodeLocate Code by running the command "python GeoCodeLocate.py" and it will return the current best guess coordinates in which the python script was run.
